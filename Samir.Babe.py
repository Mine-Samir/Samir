...
def back():
	login()
def contact():
	os.system('xdg-open https://www.facebook.com/SAMIRexeee')
	back()
def linex():
	print("""\x1b[37m----------------------------------------------""")
def cls():
...
def SAMIRresults():
    ok_file_path = '/sdcard/SAMIRv6/SAMIRv6-OK.txt'
    cp_file_path = '/sdcard/SAMIRv6/SAMIRv6-CP.txt'
...
def contact():
	os.system('xdg-open https://www.facebook.com/SAMIRexe')
